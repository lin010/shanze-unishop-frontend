<template>
	<view
		...
		:style="{ top: sz_navBar + 'px' }"
	>
		<view class="sz-toast bg-mask-80" :class="[{ hasIcon: icon != '' }]">
			<view class="sz-toast-icon" v-if="icon != ''"><text :class="[icon, {'icon-spin': isLoading }]"></text></view>
